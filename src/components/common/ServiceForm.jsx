...
const ServiceForm = ({ isOpen, onClose }) => {
  ...
  const { loading: serviceLoading } = useSelector((state) => state.services); // Get loading state from services slice
  ...
  return (
    <div className="fixed inset-0 bg-black/20 bg-opacity-30 flex items-center justify-center z-50 backdrop-blur-sm">
